                        ...
                        <form id="yw0" action="" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
										...
										<!--该表单的name属性： 
											username表示一个二维数组里有一个元素值叫username
											name[aaa 表示User二维数组中有一个元素值叫name，是array里面有一个元素值名字（key）叫aaa
										User表示php存放获取到的Value的数组名，
										[这里是数组内的元素-->
                                        <td style="width:87%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	...
                                        	<span style="color:red;"><?php echo ($errorInfo["tel"]); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
