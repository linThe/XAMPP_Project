							...
							<li class="user_main_c">
								<div class="user_main_box">
									...
									<ul>
										...
										<li class="user_main_input">
											<input class="TxtPasswordCssClass" id="admin_psd" name="admin_psd" type="password" autocomplete="off">
										</li>
									</ul>
									<ul>
										...
										<li class="user_main_input">
											...
											<img src="/shop/index.php/Admin/Manager/verifyImg" alt="你去哪了" onclick="this.src='/shop/index.php/Admin/Manager/verifyImg/'+Math.random()" />
											<span style="color: reg;"><?php echo ($loginError); ?></span>
										</li>
									</ul>
								</div>
							</li>
