...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/shop/index.php/Admin/Goods/update/goods_id/100" method="post" enctype="multipart/form-data">
            <!--隐藏域-->
            ...
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                    <td>商品图片</td>
                    <td><input type="file" name="goods_big_image" value="<?php echo ($info["goods_big_img"]); ?>" /></td>
                </tr>
                <tr>
                    <td>商品详细描述</td>
                    <td>
