        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                  ...
                  <?php if(is_array($info)): foreach($info as $key=>$value): ?><tr id="product1">
                        <td><?php echo ($value["goods_id"]); ?></td>
                        <td><a href="#"><?php echo ($value["goods_name"]); ?></a></td>
                        <td><?php echo ($value["goods_number"]); ?></td>
                        <td><?php echo ($value["goods_price"]); ?></td>
                        <td><img src="<?php echo (SITE_URL); echo ($value["goods_big_img"]); ?>" height="60" width="60"></td>
                        <td><img src="<?php echo (SITE_URL); echo ($value["goods_small_img"]); ?>" height="40" width="40"></td>
                        <td><?php echo ($value["goods_brand_id"]); ?></td>
                        <td><?php echo (date('Y-m-d H:i:s',$value["goods_create_time"])); ?></td>
                        <td><a href="/shop/index.php/Admin/Goods/update/goods_id/<?php echo ($value["goods_id"]); ?>">修改</a></td>
                        <td><a href="/shop/index.php/Admin/Goods/delete/goods_id/<?php echo ($value["goods_id"]); ?>" onclick="delete_product(1)">删除</a></td>
