...
<html>
	...
	<head>
		...
		<link href="<?php echo (ADMIN_IMG_URL); ?>admin.css" type="text/css" rel="stylesheet" />
	</head>
	...
	<body>
		<table cellspacing=0 cellpadding=0 width="100%" background="<?php echo (ADMIN_IMG_URL); ?>header_bg.jpg" border=0>
			<tr height=56>
				...
				<td style="font-weight: bold; color: #fff; padding-top: 20px" align=middle>当前用户：<?php echo (session('mg_name')); ?> &nbsp;&nbsp;
					<a style="color: #fff" href="" target=main>修改口令</a> &nbsp;&nbsp;
													<!-- 小神奇，怎么就能弹出一个小窗口询问是否推出了-->
